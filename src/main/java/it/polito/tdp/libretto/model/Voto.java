...
public class Voto implements Comparable <Voto> {
	 ...
	 * 
	 * @param corso corso nome del corso superato
	...
	/**
	 * Copy constructor di {@link Voto }, copiando 
	 * il contentuto del parametro {@code v}
	 * 
	...
	public Voto(Voto v) {
		...
		// nel caso in cui la stringa non sia immutabile
		//V.GetCorso() 
		this.corso=v.corso;
		this.data=v.data;
		this.voto=v.voto;
